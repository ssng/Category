...
local wordlist={
    ...
    {name="plumber", attributes={"profession", "fixes pipes", "fixes sinks"}},
    {name="mail man", attributes={"profession", "delivers mail", "delivers parcels", "post office"}},
    {name="fire fighter", attributes={"profession", "fights fire", "fire station"}},
    {name="police man", attributes={"profession", "catches criminals", "police station"}},
    {name="butcher", attributes={"profession", "cuts meat", "sells meat", "grocery store"}},
    {name="teacher", attributes={"profession", "teaches students", "school"}},
    {name="waiter", attributes={"profession", "takes orders", "serves food", "restaurant"}},
